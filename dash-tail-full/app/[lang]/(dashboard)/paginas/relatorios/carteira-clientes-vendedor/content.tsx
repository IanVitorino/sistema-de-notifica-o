...
import { CarteiraClientesVendedorPDF } from './components/carteira-clientes-vendedor-pdf';
...
async function fetchCarteiraClientes(params: {
  ...
  const response = await fetch('/api/paginas/relatorios/carteira-clientes-vendedor', {
    method: 'POST',
...
export function CarteiraClientesVendedorContent() {
  ...
  const {
    ...
    queryKey: ['carteira-clientes-vendedor', searchParams],
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Fabricante (opcional) */}
            <div className="space-y-2">
              <Label htmlFor="fabricante-autocomplete">Fabricante</Label>
          ...
          <div className="flex justify-end pt-4">
            <Button
              ...
              disabled={isLoadingCarteira || !vendedor}
              className="gap-2"
            >
